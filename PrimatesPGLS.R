...
LengthPrimatesDataframe$sampleMaxLifespan <- sample(as.numeric(LengthPrimatesDataframe$MaxLifespan),
                                                    size=length(as.numeric(LengthPrimatesDataframe$MaxLifespan)),replace=TRUE)
LengthPrimatesDataframe$sampleGeneLength <- sample(as.numeric(LengthPrimatesDataframe$Total_Lengths),
